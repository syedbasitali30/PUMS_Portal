...
const TableHeading = styled('b')(({ bgcolor }) => ({
    // paddingLeft: 5,
    marginBottom: 10,
}))

const TableSpace = styled('div')(({ bgcolor }) => ({
    marginTop: 10,
    marginBottom: 10,
}))
...
const StatCards2 = () => {
    ...
    const CheckSelect = (e, id) => {
        if (e == 'Print Challan') {
            window.open(
                ip.print +
                    'admission-print/VoucherPrint.html?Vou=' +
                    id.ADM_SessionID +
                    '&Info=' +
                    userData._id,
                'popUpWindow',
            ...
            window.open(
                ip.print +
                    'admission-print/FormPrint.html?Vou=' +
                    id.ADM_SessionID +
                    '&Info=' +
                    userData._id,
                'popUpWindow',
    ...
    const GETALL_SESSION = (value) => {
        axios
            .get(ip.admission + 'ADM_Session/getAll_Typ/Allied')
            .then((res) => {
    ...
    const GETALL_PROGRAM_APPLY = () => {
        const dataTosend = { id: userData._id, typ: 'Allied' }
        axios
                                                                    ...
                                                                    onClick={() => {
                                                                        {
                                                                            ...
                                                                            'Yes'
                                                                                ? navigate(
                                                                                      '/Admission/ADM_ElectiveSub'
                                                                                  )
                                                                                : navigate(
                                                                                      '/Admission/ADM_ChooseDept'
                                                                                  )
                                                                        }
                                        ...
                                        <Small
                                            onClick={() => {
                                                userData.BasicInfo === 0
                                                    ? navigate(
                                                          '/Admission/ADM_BasicInfo'
                                                      )
                                                    : navigate(
                                                          '/Admission/ADM_Dashboard'
                                                      )
                                            }}
                                            bgcolor={
                                                userData.BasicInfo === 0
