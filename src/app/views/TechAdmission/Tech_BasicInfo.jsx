...
const SimpleForm = () => {
    ...
    useEffect(() => {
        if (userData.BasicInfo == 0) {
            setInitialProfile(
                'https://raw.githubusercontent.com/syedbasitali30/images/main/profileTech.png'
            )
        } else {
            setInitialProfile(
    ...
    const GETALL_DISTRICT = (v, arr) => {
        ...
        axios
            .get(
                ip.admission +
                    'ADM_State/getDis_byState/6374e566875d563bebdfd5a9'
            )
            .then((res) => {
                ...
                <ValidatorForm onSubmit={handleSubmit} onError={() => null}>
                    ...
                    <Grid container spacing={4} sx={{ mt: 0 }}>
                        <Grid item lg={6} md={6} sm={12} xs={12} sx={{ mt: 2 }}>
                            <SimpleCard title="Father’s / Guardian’s Information">
                                <Grid lg={12} md={12} sm={12} xs={12}>
                                    <TextField
                                        size={'small'}
                                        type="text"
